...
@sys.description('Name of keyvault that contains disk encryption key.')
...
@sys.description('Key Vault disk encryption key name.')
param ztKvKeyName string
    ...
    params: {
        ...
        extensionAzureDiskEncryptionConfig: {
            ...
            settings: {
                ...
                volumeType: 'All'
                // aadClientId: keyVault.getSecret('aadClientId')
                // aadSecret: keyVault.getSecret('aadSecret')
                //sequenceVersion: '1.0'
            }
        }
        tags: tags
